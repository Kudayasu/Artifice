...
namespace XboxWdpDriver
{
    ...
    public class Program
    {
            ...
            try
            {
                ...
                else
                {
                    ...
                    switch (operation)
                    {
                        ...
                        case OperationType.TerminateProcessOperation:
                            TerminateProcessOperation.HandleOperation(portal, parameters);
                            break;
        ...
        private static OperationType OperationStringToEnum(string operation)
        {
            ...
            else if (operation.Equals("terminateprocess", StringComparison.OrdinalIgnoreCase))
            {
                return OperationType.TerminateProcessOperation;
            }
